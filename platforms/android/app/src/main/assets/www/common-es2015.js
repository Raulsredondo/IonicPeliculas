...
let AuthService = class AuthService {
    ...
    onRegister(user) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                return yield this.afAuth.auth.createUserWithEmailAndPassword(user.email, user.password);
            }
            catch (error) {
...
let PeliculasService = class PeliculasService {
    constructor(db, afAuth, l) {
        this.db = db;
        this.afAuth = afAuth;
        this.pelisCollection = db.collection('peliculas');
        this.pelis = this.pelisCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
        ...
        this.pelisfav = this.pelisFavCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    getpeliculasRooms() {
        return this.db.collection('peliculas').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(rooms => {
            return rooms.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
