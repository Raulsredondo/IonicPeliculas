...
var routes = [
    ...
    {
        path: 'add-peliculas',
        loadChildren: function () { return Promise.all(/*! import() | add-peliculas-add-peliculas-module */[__webpack_require__.e("common"), __webpack_require__.e("add-peliculas-add-peliculas-module")]).then(__webpack_require__.bind(null, /*! ./add-peliculas/add-peliculas.module */ "./src/app/add-peliculas/add-peliculas.module.ts")).then(function (m) { return m.AddPeliculasPageModule; }); }
    },
    {
        path: 'info-pelis/:id',
        loadChildren: function () { return Promise.all(/*! import() | info-pelis-info-pelis-module */[__webpack_require__.e("common"), __webpack_require__.e("info-pelis-info-pelis-module")]).then(__webpack_require__.bind(null, /*! ./info-pelis/info-pelis.module */ "./src/app/info-pelis/info-pelis.module.ts")).then(function (m) { return m.InfoPelisPageModule; }); }
    },
    {
        path: 'info-pelis',
        loadChildren: function () { return Promise.all(/*! import() | info-pelis-info-pelis-module */[__webpack_require__.e("common"), __webpack_require__.e("info-pelis-info-pelis-module")]).then(__webpack_require__.bind(null, /*! ./info-pelis/info-pelis.module */ "./src/app/info-pelis/info-pelis.module.ts")).then(function (m) { return m.InfoPelisPageModule; }); }
    ...
    {
        path: 'favoritos',
        loadChildren: function () { return Promise.all(/*! import() | favoritos-favoritos-module */[__webpack_require__.e("common"), __webpack_require__.e("favoritos-favoritos-module")]).then(__webpack_require__.bind(null, /*! ./favoritos/favoritos.module */ "./src/app/favoritos/favoritos.module.ts")).then(function (m) { return m.FavoritosPageModule; }); }
    }
];
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].firebaseConfig),
                _angular_fire_auth__WEBPACK_IMPORTED_MODULE_10__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_12__["AngularFirestoreModule"]],
            providers: [
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyB2OCdlA5KEtaNUKAQrhAHAqqRd3WsdeCI",
        authDomain: "angular-ioninc.firebaseapp.com",
        databaseURL: "https://angular-ioninc.firebaseio.com",
        projectId: "angular-ioninc",
        storageBucket: "angular-ioninc.appspot.com",
        messagingSenderId: "178583028269",
        appId: "1:178583028269:web:a3e71123ba1e8402af2ea4",
        measurementId: "G-RN32EBBD4Y"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Proyecto Angular y Ionic\IonicPeliculas\src\main.ts */"./src/main.ts");
